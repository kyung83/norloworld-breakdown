...
export default function ComboBoxCategory({
  ...
  useEffect(() => {
    if (selectedSubCategory?.name === "OTHER") {
  ...
  useEffect(() => {
    if (selectedCategory?.name === "OTHER" && typeof onCategoryChange === 'function') {
      onCategoryChange({id: 'custom', name: customCategory});
    }
  }, [customCategory, onCategoryChange]);
  
  useEffect(() => {
    if (selectedSubCategory?.name === "OTHER" && typeof onSubCategoryChange === 'function') {
...
function SingleComboBox({
  ...
  if (!filteredPeople.some((item) => item.name === "OTHER")) {
    filteredPeople.push({ id: "other", name: "OTHER" });
  }
